    ...
    if (this.isSpeedy) {
      ...
      try {
        ...
        if (!/:(-moz-placeholder|-moz-focus-inner|-moz-focusring|-ms-input-placeholder|-moz-read-write|-moz-read-only|-ms-clear|-ms-expand|-ms-reveal){/.test(rule)) {
          console.error('There was a problem inserting the following rule: "' + rule + '"', e7);
        }
      }
    } else {
...
function ruleset(value, root, parent, index, offset, rules, points, type, props, children, length2) {
  ...
  for (var i6 = 0, j3 = 0, k3 = 0; i6 < index; ++i6)
    for (var x5 = 0, y4 = substr(value, post + 1, post = abs(j3 = points[i6])), z3 = value; x5 < size2; ++x5)
      if (z3 = trim(j3 > 0 ? rule[x5] + " " + y4 : replace(y4, /&\f/g, rule[x5])))
        props[k3++] = z3;
...
function middleware(collection) {
  ...
  return function(element, index, children, callback) {
    var output = "";
    for (var i6 = 0; i6 < length2; i6++)
      output += collection[i6](element, index, children, callback) || "";
    return output;
  };
}
...
var compat = function compat2(element) {
  ...
  for (var i6 = 0, k3 = 0; i6 < rules.length; i6++) {
    for (var j3 = 0; j3 < parentRules.length; j3++, k3++) {
      element.props[k3] = points[i6] ? rules[i6].replace(/&\f/g, parentRules[j3]) : parentRules[j3] + " " + rules[i6];
    }
  }
};
...
function _extends() {
  return _extends = Object.assign ? Object.assign.bind() : function(n6) {
    for (var e7 = 1; e7 < arguments.length; e7++) {
      var t6 = arguments[e7];
      for (var r6 in t6) ({}).hasOwnProperty.call(t6, r6) && (n6[r6] = t6[r6]);
    }
    return n6;
...
function murmur2(str) {
  var h4 = 0;
  var k3, i6 = 0, len = str.length;
  for (; len >= 4; ++i6, len -= 4) {
    k3 = str.charCodeAt(i6) & 255 | (str.charCodeAt(++i6) & 255) << 8 | (str.charCodeAt(++i6) & 255) << 16 | (str.charCodeAt(++i6) & 255) << 24;
    k3 = /* Math.imul(k, m): */
  ...
  switch (len) {
    case 3:
      h4 ^= (str.charCodeAt(i6 + 2) & 255) << 16;
    case 2:
      h4 ^= (str.charCodeAt(i6 + 1) & 255) << 8;
    case 1:
      h4 ^= str.charCodeAt(i6) & 255;
      h4 = /* Math.imul(h, m): */
      (h4 & 65535) * 1540483477 + ((h4 >>> 16) * 59797 << 16);
  }
  h4 ^= h4 >>> 13;
...
function serializeStyles(args, registered, mergedProps) {
  ...
  for (var i6 = 1; i6 < args.length; i6++) {
    ...
    if (stringMode) {
      ...
      if (templateStringsArr[i6] === void 0) {
        console.error(ILLEGAL_ESCAPE_SEQUENCE_ERROR);
      }
      styles += templateStringsArr[i6];
    }
  }
...
var getLabelFromStackTrace = function getLabelFromStackTrace2(stackTrace) {
  ...
  for (var i6 = 0; i6 < lines.length; i6++) {
    var functionName = getFunctionNameFromStackTraceLine(lines[i6]);
...
var jsx = function jsx2(type, props) {
  ...
  for (var i6 = 2; i6 < argsLength; i6++) {
    createElementArgArray[i6] = args[i6];
  }
...
var Insertion3 = function Insertion4(_ref) {
  ...
  useInsertionEffectAlwaysWithSyncFallback(function() {
    for (var i6 = 0; i6 < serializedArr.length; i6++) {
      insertStyles(cache, serializedArr[i6], false);
    }
  });
  return null;
};
...
// node_modules/@table-library/react-table-library/styles-492c6342.js
function t() {
  return l = t = Object.assign || function(g3) {
    for (var c3 = 1; c3 < arguments.length; c3++) {
      var I2 = arguments[c3];
      for (var t6 in I2) Object.prototype.hasOwnProperty.call(I2, t6) && (g3[t6] = I2[t6]);
    }
    return g3;
...
var l = t;
var n = l;
var i = function(g3, c3) {
  if (null == g3) return {};
  var I2, t6, l2 = {}, n6 = Object.keys(g3);
  for (t6 = 0; t6 < n6.length; t6++) I2 = n6[t6], c3.indexOf(I2) >= 0 || (l2[I2] = g3[I2]);
  return l2;
};
var e = function(g3, c3) {
  if (null == g3) return {};
  var I2, t6, l2 = i(g3, c3);
  if (Object.getOwnPropertySymbols) {
    var n6 = Object.getOwnPropertySymbols(g3);
    for (t6 = 0; t6 < n6.length; t6++) I2 = n6[t6], c3.indexOf(I2) >= 0 || Object.prototype.propertyIsEnumerable.call(g3, I2) && (l2[I2] = g3[I2]);
  }
  return l2;
};
var b = g.createContext(null);
var u = function(g3) {
  var c3 = g3.current.querySelector(".tr-header");
  return Array.from((null == c3 ? void 0 : c3.querySelectorAll(".th")) || []);
};
var C = function(g3, c3, I2, t6) {
  return Array.from(g3.current.querySelectorAll(I2)).forEach(function(g4) {
    var I3 = Array.from(g4.querySelectorAll(t6)), l2 = I3.length;
    I3.forEach(function(g5, I4) {
      return c3(g5, I4, l2);
    });
  });
};
var o = function(g3, c3) {
  return C(g3, c3, ".tr-header", ".th");
};
var a = function(g3, c3) {
  return C(g3, c3, ".tr-body", ".td");
};
var G = function(g3, c3) {
  return { index: c3, minWidth: +g3.getAttribute("data-resize-min-width"), width: g3.getBoundingClientRect().width, isStiff: g3.classList.contains("stiff"), isHide: "true" === g3.getAttribute("data-hide"), isColSpan: g3.classList.contains("colspan") };
};
var A = g.createContext(null);
var X = function(I2) {
  var t6 = I2.tableElementRef, l2 = I2.tableMemoryRef, n6 = I2.layout, i6 = I2.children, e7 = g.useMemo(function() {
    return { layout: n6, tableElementRef: t6, tableMemoryRef: l2 };
  }, [n6, t6, l2]);
  return jsx(A.Provider, { value: e7 }, i6);
};
var d = function(g3, c3) {
  var I2 = u(g3).map(G);
  c3.current.dataColumns = I2;
};
var r2 = function(g3, c3, I2) {
  var t6 = c3.current.style.getPropertyValue("--data-table-library_grid-template-columns") !== g3;
  c3.current && g3 && t6 && (c3.current.style.setProperty("--data-table-library_grid-template-columns", g3), d(c3, I2));
};
var x = function(g3, c3) {
  null != c3 && c3.onLayoutChange && g3 && c3.onLayoutChange(g3);
};
var y = "\n  ".concat(function() {
}, "\n  padding: 0;\n  margin: 0;\n\n  ").concat(function() {
}, "\n  display: flex;\n  align-items: center;\n\n  ").concat(function() {
...
var p = g.forwardRef(function(I2, t6) {
  var l2 = g.useContext(A);
  if (!l2) throw new Error("No Layout Context.");
  var i6 = l2.layout, e7 = null != i6 && i6.isDiv ? "div" : "td";
  return jsx(e7, n({ css: s, ref: t6 }, I2));
});
...
var Z = g.forwardRef(function(I2, t6) {
  var l2 = g.useContext(A);
  if (!l2) throw new Error("No Layout Context.");
  var i6 = l2.layout, e7 = null != i6 && i6.isDiv ? "div" : "th";
  return jsx(e7, n({ css: B, ref: t6 }, I2));
});
...
var r3 = function(r6, t6) {
  (null == t6 || t6 > r6.length) && (t6 = r6.length);
  for (var n6 = 0, e7 = new Array(t6); n6 < t6; n6++) e7[n6] = r6[n6];
  return e7;
};
var t2 = r3;
var n2 = function(r6, n6) {
  if (r6) {
    if ("string" == typeof r6) return t2(r6, n6);
    var e7 = Object.prototype.toString.call(r6).slice(8, -1);
    return "Object" === e7 && r6.constructor && (e7 = r6.constructor.name), "Map" === e7 || "Set" === e7 ? Array.from(r6) : "Arguments" === e7 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e7) ? t2(r6, n6) : void 0;
  }
};
...
var e2 = function(r6, t6) {
  if ("undefined" != typeof Symbol && Symbol.iterator in Object(r6)) {
    var e7 = [], n6 = true, o8 = false, a7 = void 0;
    try {
      for (var i6, u5 = r6[Symbol.iterator](); !(n6 = (i6 = u5.next()).done) && (e7.push(i6.value), !t6 || e7.length !== t6); n6 = true) ;
    } catch (r7) {
      o8 = true, a7 = r7;
    } finally {
      try {
        n6 || null == u5.return || u5.return();
      } finally {
        if (o8) throw a7;
      }
    }
...
var a2 = function(r6, a7) {
  return t3(r6) || e2(r6, a7) || n3(r6, a7) || o2();
};
...
var e3 = function(e7, r6, n6) {
  return r6 in e7 ? Object.defineProperty(e7, r6, { value: n6, enumerable: true, configurable: true, writable: true }) : e7[r6] = n6, e7;
};

// node_modules/@table-library/react-table-library/toConsumableArray-25e5c43c.js
var e4 = r3;
var n4 = function(r6) {
  if (Array.isArray(r6)) return e4(r6);
};
var o3 = function(r6) {
  if ("undefined" != typeof Symbol && Symbol.iterator in Object(r6)) return Array.from(r6);
};
var a3 = n2;
var i2 = function() {
...
function X2(e7, c3) {
  var t6 = Object.keys(e7);
  if (Object.getOwnPropertySymbols) {
    var l2 = Object.getOwnPropertySymbols(e7);
    c3 && (l2 = l2.filter(function(c4) {
      return Object.getOwnPropertyDescriptor(e7, c4).enumerable;
    })), t6.push.apply(t6, l2);
  }
  return t6;
}
function V(e7) {
  for (var c3 = 1; c3 < arguments.length; c3++) {
    var t6 = null != arguments[c3] ? arguments[c3] : {};
    c3 % 2 ? X2(Object(t6), true).forEach(function(c4) {
      e3(e7, c4, t6[c4]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e7, Object.getOwnPropertyDescriptors(t6)) : X2(Object(t6)).forEach(function(c4) {
      Object.defineProperty(e7, c4, Object.getOwnPropertyDescriptor(t6, c4));
    });
  }
  return e7;
}
var y2 = function(b3, C3) {
  var i6 = e5.useContext(A);
  if (!i6) throw new Error("No Layout Context.");
  var u5 = i6.tableElementRef, a7 = i6.tableMemoryRef, d5 = i6.layout, s4 = e5.useRef(null), m2 = e5.useRef(null), o8 = e5.useRef(""), A5 = e5.useRef(null), G3 = e5.useRef(false), W3 = e5.useCallback(function(e7) {
    var c3;
    e7.preventDefault(), o8.current = u5.current.style.getPropertyValue("--data-table-library_grid-template-columns"), G3.current = true, A5.current = s4.current.offsetWidth - e7.pageX, null === (c3 = s4.current) || void 0 === c3 || c3.querySelector(".resizer-area").classList.add("active");
  }, [u5]), X3 = e5.useCallback(function(e7) {
    if (G3.current) {
      e7.preventDefault();
      var c3 = A5.current + e7.pageX, l2 = function(e8, c4, t6, l3) {
        var b4 = u(t6).map(G).filter(function(e9) {
          return !e9.isHide;
        }), C4 = b4.findIndex(function(c5) {
          return c5.index === e8;
        }), i7 = (b4 = b4.map(function(e9, c5) {
          return V(V({}, e9), {}, { index: c5 });
        })).reduce(function(e9, c5, t7) {
          return e9 || (t7 > C4 && 0 !== c5.width ? c5 : e9);
        }, null), u6 = b4.reduce(function(e9, c5) {
          return e9 + c5.width;
        }, 0), a8 = b4[C4].minWidth, d6 = l3 > a8 && 0 !== l3 ? l3 : a8, s5 = d6 - b4[C4].width, m3 = b4.map(function(e9, c5) {
          if (i7 && C4 === c5) return i7.width - s5 > a8 ? d6 : e9.width;
          if ((null == i7 ? void 0 : i7.index) === c5) {
            var t7 = e9.width - s5;
            return t7 > a8 ? t7 : e9.width;
          }
          return e9.width;
        }), o9 = u6 - m3.reduce(function(e9, c5) {
          return e9 + c5;
        }, 0);
        m3[C4] = m3[C4] + o9;
        var A6 = false, G4 = b4.slice(0).reverse().map(function(e9, t7) {
          var l4 = m3.slice(0).reverse()[t7], n6 = l4 / u6 * 100;
          return e9.isStiff || null != c4 && c4.horizontalScroll ? "".concat(l4, "px") : A6 ? "minmax(0, ".concat(n6, "%)") : (A6 = true, "minmax(0, 1fr)");
        }).slice(0).reverse().join(" "), W4 = function(e9, c5) {
          if (u2(Array.from(e9.classList)).includes("pin-left")) {
            var t7 = m3.reduce(function(e10, t8, l5) {
              return l5 >= c5 ? e10 : e10 + t8;
            }, 0);
            e9.style.left = "".concat(t7, "px");
          }
          if (u2(Array.from(e9.classList)).includes("pin-right")) {
            var l4 = m3.reduceRight(function(e10, t8, l5) {
              return l5 <= c5 ? e10 : e10 + t8;
            }, 0);
            e9.style.right = "".concat(l4, "px");
          }
        };
        return o(t6, W4), a(t6, W4), G4;
      }(b3, d5, u5, c3);
      r2(l2, u5, a7);
    }
  }, [b3, d5, u5, a7]), y4 = e5.useCallback(function() {
    var e7;
    G3.current = false;
    var c3 = u5.current.style.getPropertyValue("--data-table-library_grid-template-columns");
    if (o8.current !== c3) {
      x(c3, d5);
      var t6 = u(u5).map(G);
      a7.current.dataColumns = t6;
    }
    null === (e7 = s4.current) || void 0 === e7 || e7.querySelector(".resizer-area").classList.remove("active");
  }, [d5, u5, a7]);
  return e5.useEffect(function() {
    var e7 = m2.current;
    return e7 && (e7.addEventListener("mousedown", W3), document.addEventListener("mousemove", X3), document.addEventListener("mouseup", y4)), function() {
      e7 && (e7.removeEventListener("mousedown", W3), document.removeEventListener("mousemove", X3), document.removeEventListener("mouseup", y4));
    };
  }, [C3, W3, X3, y4]), { cellRef: s4, resizeRef: m2 };
};
...
var i3 = null;
var r4 = function() {
  return i3 || (i3 = c.createContext(null));
};
var a4 = function() {
  return c.useContext(i3);
};
var s2 = function(c3) {
...
function u3(c3, t6) {
  var g3 = Object.keys(c3);
  if (Object.getOwnPropertySymbols) {
    var l2 = Object.getOwnPropertySymbols(c3);
    t6 && (l2 = l2.filter(function(t7) {
      return Object.getOwnPropertyDescriptor(c3, t7).enumerable;
    })), g3.push.apply(g3, l2);
  }
  return g3;
}
function A3(c3) {
  for (var t6 = 1; t6 < arguments.length; t6++) {
    var g3 = null != arguments[t6] ? arguments[t6] : {};
    t6 % 2 ? u3(Object(g3), true).forEach(function(t7) {
      e3(c3, t7, g3[t7]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(c3, Object.getOwnPropertyDescriptors(g3)) : u3(Object(g3)).forEach(function(t7) {
      Object.defineProperty(c3, t7, Object.getOwnPropertyDescriptor(g3, t7));
    });
  }
  return c3;
}
var o4 = function(n6) {
  n6.index;
  var i6 = n6.className, r6 = n6.hide, a7 = n6.pinLeft, s4 = n6.pinRight, u5 = n6.stiff, o8 = n6.includePreviousColSpan, m2 = n6.previousColSpans, G3 = n6.gridColumnStart, p4 = n6.gridColumnEnd, W3 = n6.onClick, N2 = n6.children, x5 = n6.style, y4 = e(n6, d2), H3 = c.useContext(b), Z2 = G3 && p4, J = Z2 ? p4 - G3 - 1 : 0, X3 = o8 ? G3 + m2 : G3, V2 = o8 ? p4 + m2 : p4;
  return jsx(c.Fragment, null, jsx(p, n({ role: "gridcell", "data-table-library_td": "", style: A3(A3({}, Z2 ? { gridColumnStart: X3, gridColumnEnd: V2 } : {}), x5), css: css(null == H3 ? void 0 : H3.BaseCell, " ", null == H3 ? void 0 : H3.Cell, ";" + (false ? "" : ";label:Cell;"), false ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"), className: clsx_m_default("td", i6, { stiff: u5, hide: r6, "pin-left": a7, "pin-right": s4 }), onClick: W3 }, y4), jsx("div", null, N2)), Array.from({ length: J }, function() {
...
var o5 = null;
var u4 = function() {
  return o5 || (o5 = t4.createContext(null));
};
var a5 = function() {
  return t4.useContext(o5);
};
var c2 = null;
var s3 = function() {
  return c2 || (c2 = t4.createContext(null));
};
var i4 = function() {
  var n6 = t4.useState(false), r6 = a2(n6, 2), o8 = r6[0], u5 = r6[1];
  return t4.useEffect(function() {
    var e7 = function(e8) {
      e8.shiftKey ? u5(true) : o8 && u5(false);
    }, t6 = function() {
      o8 && u5(false);
    };
    return document && (document.addEventListener("keydown", e7), document.addEventListener("keyup", t6)), function() {
      document && (document.removeEventListener("keydown", e7), document.removeEventListener("keyup", t6));
    };
  }, [o8]), o8;
};
var d3 = function() {
  return { select: a5(), tree: a4(), sort: W2(), pagination: t4.useContext(c2) };
};

// node_modules/@table-library/react-table-library/modifiers-d418f2b2.js
var o6 = function(o8) {
  var i6 = o8.sort, t6 = o8.pagination, a7 = o8.tree;
  return function(o9) {
    var e7 = u2(o9);
    return e7 = i6 ? i6.modifier(e7) : e7, e7 = t6 ? t6.modifier(e7) : e7, e7 = a7 ? a7.modifier(e7) : e7;
  };
};
...
function U(I2) {
  for (var g3 = 1; g3 < arguments.length; g3++) {
    var c3 = null != arguments[g3] ? arguments[g3] : {};
    g3 % 2 ? j(Object(c3), true).forEach(function(g4) {
      e3(I2, g4, c3[g4]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(I2, Object.getOwnPropertyDescriptors(c3)) : j(Object(c3)).forEach(function(g4) {
      Object.defineProperty(I2, g4, Object.getOwnPropertyDescriptor(c3, g4));
    });
  }
  return I2;
}
var Q = function(l2) {
  var t6, u5 = l2.className, W3 = l2.role, X3 = void 0 === W3 ? "rowheader" : W3, J = l2.isFooter, a7 = l2.children, y4 = e(l2, f), s4 = d4.useContext(b), m2 = d4.useRef(null);
  return t6 = d4.useContext(A), d4.useLayoutEffect(function() {
    var I2;
    if (!t6) throw new Error("No Layout Context.");
    var g3 = t6.layout, c3 = t6.tableElementRef, l3 = t6.tableMemoryRef, b3 = u(c3).map(G);
    if (null === (I2 = l3.current) || void 0 === I2 || !I2.onlyOnce) if (l3.current.onlyOnce = true, null != g3 && g3.resizedLayout) {
      var d5 = null == g3 ? void 0 : g3.resizedLayout;
      r2(d5, c3, l3);
    } else if (null != g3 && g3.custom) d(c3, l3);
    else {
      var Z2 = b3.filter(function(I3) {
        return !I3.isHide;
      }).map(function() {
        return "minmax(0px, 1fr)";
      }).join(" ");
...
function w(I2) {
  for (var g3 = 1; g3 < arguments.length; g3++) {
    var c3 = null != arguments[g3] ? arguments[g3] : {};
    g3 % 2 ? D(Object(c3), true).forEach(function(g4) {
      e3(I2, g4, c3[g4]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(I2, Object.getOwnPropertyDescriptors(c3)) : D(Object(c3)).forEach(function(g4) {
      Object.defineProperty(I2, g4, Object.getOwnPropertyDescriptor(c3, g4));
    });
  }
  return I2;
...
var O = function(l2) {
  var b3 = l2.item, C3 = l2.className, e7 = l2.disabled, n6 = l2.onClick, A5 = l2.onDoubleClick, t6 = l2.children, u5 = e(l2, k), W3 = function(I2, g3) {
    return Object.values(I2).filter(Boolean).filter(function(I3) {
      return null == I3 ? void 0 : I3.hasOwnProperty("_getRowProps");
    }).map(function(c3) {
      return c3._getRowProps(g3, I2);
    });
  }(d3(), l2), X3 = d4.useContext(b), J = function(I2, g3) {
    var c3 = I2.reduce(function(I3, g4) {
      var c4 = g4.theme, l3 = g4.className, b4 = g4.onClick, C4 = "\n        ".concat(I3.themeByFeature, "\n        ").concat(c4, "\n      "), e8 = clsx_m_default(I3.classNamesByFeature, l3), n7 = I3.clickable || !!b4;
      return w(w({}, I3), {}, { themeByFeature: C4, classNamesByFeature: e8, clickable: n7, onClickByFeature: function(g5, c5) {
        b4(g5, c5), I3.onClickByFeature(g5, c5);
      } });
    }, { themeByFeature: "", classNamesByFeature: "", clickable: !!g3, onClickByFeature: function(I3, c4) {
      g3 && s2(c4) && g3(I3, c4);
    } });
...
function _setPrototypeOf(t6, e7) {
  return _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(t7, e8) {
    return t7.__proto__ = e8, t7;
  }, _setPrototypeOf(t6, e7);
}

// node_modules/@babel/runtime/helpers/esm/inheritsLoose.js
function _inheritsLoose(t6, o8) {
  t6.prototype = Object.create(o8.prototype), t6.prototype.constructor = t6, _setPrototypeOf(t6, o8);
}
...
function areInputsEqual(newInputs, lastInputs) {
  ...
  for (var i6 = 0; i6 < newInputs.length; i6++) {
    if (!isEqual(newInputs[i6], lastInputs[i6])) {
      return false;
    }
  }
  return true;
...
function createGridComponent(_ref2) {
  ...
  return _class = function(_PureComponent) {
    ...
    _proto.render = function render() {
      ...
      if (columnCount > 0 && rowCount) {
        for (var _rowIndex = rowStartIndex; _rowIndex <= rowStopIndex; _rowIndex++) {
          for (var _columnIndex = columnStartIndex; _columnIndex <= columnStopIndex; _columnIndex++) {
            items.push((0, import_react7.createElement)(children, {
      ...
      var estimatedTotalHeight = getEstimatedTotalHeight4(this.props, this._instanceProps);
      var estimatedTotalWidth = getEstimatedTotalWidth4(this.props, this._instanceProps);
      return (0, import_react7.createElement)(outerElementType || outerTagName || "div", {
        className,
      ...
      }, (0, import_react7.createElement)(innerElementType || innerTagName || "div", {
        children: items,
        ref: innerRef,
        style: {
    ...
    return Grid;
  }(import_react7.PureComponent), _class.defaultProps = {
    direction: "ltr",
    itemData: void 0,
...
var getItemMetadata = function getItemMetadata2(itemType, props, index, instanceProps) {
  ...
  if (index > lastMeasuredIndex) {
    ...
    for (var i6 = lastMeasuredIndex + 1; i6 <= index; i6++) {
      var size2 = itemSize(i6);
      itemMetadataMap[i6] = {
        offset,
        size: size2
      };
...
var slicedToArray = /* @__PURE__ */ function() {
  ...
  return function(arr, i6) {
    if (Array.isArray(arr)) {
      return arr;
    } else if (Symbol.iterator in Object(arr)) {
      return sliceIterator(arr, i6);
    } else {
      throw new TypeError("Invalid attempt to destructure non-iterable instance");
    }
  };
...
function createDetectElementResize(nonce) {
  ...
  if (!attachEvent) {
    ...
    scrollListener = function scrollListener2(e7) {
    ...
    var pfx = "";
    {
      ...
      if (animation === false) {
        for (var i6 = 0; i6 < domPrefixes.length; i6++) {
...
var a6 = function(a7, r6, t6) {
  var e7 = 0;
  return a7 && ("number" == typeof a7 && (e7 = a7), "function" == typeof a7 && (e7 = a7(r6, t6))), e7;
};
var r5 = { display: "grid", gridTemplateColumns: "var(--data-table-library_grid-template-columns)" };

// node_modules/@table-library/react-table-library/compact.js
var y3 = ["columns"];
var j2 = function(e7, r6) {
  var t6 = e7.indexOf(r6);
  return (t6 > -1 ? e7.slice(0, t6 + 1) : []).filter(function(e8) {
    return e8.select;
  }).length;
};
var P2 = function(n6) {
  var i6 = n6.columns, l2 = e(n6, y3), s4 = l2.sort, c3 = l2.select;
  return jsx(i5, null, jsx(Q, null, i6.map(function(e7, o8) {
    var n7 = null;
    c3 && e7.select && (n7 = "boolean" != typeof e7.select && e7.select.renderHeaderCellSelect ? jsx(v, { stiff: true }, e7.select.renderHeaderCellSelect()) : jsx(c3.components.HeaderCellSelect, null));
    var l3 = { index: o8 + j2(i6, e7), resize: e7.resize, pinLeft: e7.pinLeft, pinRight: e7.pinRight, hide: e7.hide }, a7 = null;
    return a7 = s4 && e7.sort && e7.sort.sortKey ? jsx(s4.components.HeaderCellSort, n({}, l3, { sortKey: e7.sort.sortKey, sortIcon: e7.sort.sortIcon }), e7.label) : jsx(v, l3, e7.label), jsx(t5.Fragment, { key: o8 }, n7, a7);
  })));
};
var g2 = ["index", "item", "columns", "rowProps", "rowOptions"];
function h3(e7, r6) {
  var t6 = Object.keys(e7);
  if (Object.getOwnPropertySymbols) {
    var o8 = Object.getOwnPropertySymbols(e7);
    r6 && (o8 = o8.filter(function(r7) {
...
function C2(e7) {
  for (var r6 = 1; r6 < arguments.length; r6++) {
    var t6 = null != arguments[r6] ? arguments[r6] : {};
    r6 % 2 ? h3(Object(t6), true).forEach(function(r7) {
      e3(e7, r7, t6[r7]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e7, Object.getOwnPropertyDescriptors(t6)) : h3(Object(t6)).forEach(function(r7) {
      Object.defineProperty(e7, r7, Object.getOwnPropertyDescriptor(t6, r7));
    });
  }
  return e7;
}
var z2 = function(o8) {
  var i6 = o8.index, l2 = o8.item, s4 = o8.columns, c3 = o8.rowProps, a7 = o8.rowOptions, p4 = e(o8, g2), f2 = p4.tree, m2 = p4.select;
  return jsx(t5.Fragment, null, (null == a7 ? void 0 : a7.renderBeforeRow) && a7.renderBeforeRow(l2, i6), jsx(O, n({ item: l2 }, c3), s4.map(function(e7, o9) {
    var n6 = { pinLeft: e7.pinLeft, pinRight: e7.pinRight, hide: e7.hide }, i7 = function(e8, r6) {
      return Object.keys(e8).reduce(function(t6, o10) {
        return "function" == typeof e8[o10] ? t6[o10] = e8[o10](r6) : t6[o10] = e8[o10], t6;
      }, {});
    }((null == e7 ? void 0 : e7.cellProps) || {}, l2), s5 = null;
    if (f2 && e7.tree) {
      var c4 = {};
      "boolean" != typeof e7.tree && (c4 = C2(C2({}, c4), {}, { treeIcon: e7.tree.treeIcon })), s5 = jsx(f2.components.CellTree, n({ item: l2 }, i7, n6, c4), e7.renderCell(l2));
    } else s5 = jsx(o4, n({}, i7, n6), e7.renderCell(l2));
    var a8 = null;
    return m2 && e7.select && (a8 = "boolean" != typeof e7.select && e7.select.renderCellSelect ? jsx(o4, { stiff: true }, e7.select.renderCellSelect(l2)) : jsx(m2.components.CellSelect, { item: l2 })), jsx(t5.Fragment, { key: o9 }, a8, s5);
  })), (null == a7 ? void 0 : a7.renderAfterRow) && a7.renderAfterRow(l2, i6));
};
var S2 = ["columns"];
var x4 = ["children"];
var R3 = ["internals", "columns", "rowProps", "rowOptions", "virtualizedOptions"];
var H2 = ["tableList", "columns", "rowProps", "rowOptions", "virtualizedOptions"];
function L2(e7, r6) {
  var t6 = Object.keys(e7);
  if (Object.getOwnPropertySymbols) {
    var o8 = Object.getOwnPropertySymbols(e7);
...
function T2(e7) {
  for (var r6 = 1; r6 < arguments.length; r6++) {
    var t6 = null != arguments[r6] ? arguments[r6] : {};
    r6 % 2 ? L2(Object(t6), true).forEach(function(r7) {
      e3(e7, r7, t6[r7]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e7, Object.getOwnPropertyDescriptors(t6)) : L2(Object(t6)).forEach(function(r7) {
      Object.defineProperty(e7, r7, Object.getOwnPropertyDescriptor(t6, r7));
    });
  }
  return e7;
...
var k2 = function(o8) {
  var n6 = o8.columns, i6 = e(o8, S2);
  return t5.forwardRef(function(t6, o9) {
    var l2 = t6.children, s4 = e(t6, x4);
    return jsx("div", n({ ref: o9 }, s4), jsx("div", { style: T2(T2({}, r5), {}, { position: "sticky", insetBlockStart: 0, zIndex: 3 }) }, jsx(P2, n({ columns: n6 }, i6))), jsx(o7, null, l2));
  });
};
var D2 = function(t6) {
  var o8 = t6.internals, n6 = t6.columns, i6 = t6.rowProps, l2 = t6.rowOptions, s4 = t6.virtualizedOptions, c3 = e(t6, R3), a7 = o8.index, p4 = o8.style, f2 = o8.data.items[a7], m2 = a6(null == s4 ? void 0 : s4.rowHeight, f2, a7);
  return jsx("div", { style: T2(T2(T2({}, p4), r5), {}, { top: p4.top + m2 }) }, jsx(z2, n({ index: a7, item: f2, columns: n6, rowProps: i6, rowOptions: l2 }, c3)));
};
var I = function(t6) {
  var o8 = t6.tableList, n6 = t6.columns, i6 = t6.rowProps, l2 = void 0 === i6 ? {} : i6, s4 = t6.rowOptions, c3 = t6.virtualizedOptions, a7 = e(t6, H2);
  return jsx(index_esm_default, null, function(e7) {
    var t7 = e7.width, i7 = e7.height;
    return jsx(VariableSizeList, { height: i7, width: t7, itemCount: (null == c3 ? void 0 : c3.itemCount) || o8.length, itemSize: function(e8) {
      return a6(null == c3 ? void 0 : c3.rowHeight, o8[e8], e8);
    }, innerElementType: k2(T2({ columns: n6 }, a7)), itemData: { items: o8 } }, function(e8) {
      return jsx(D2, n({ internals: e8, columns: n6, rowProps: l2, rowOptions: s4, virtualizedOptions: c3 }, a7));
    });
  });
};
var A4 = ["tableList", "columns", "rowProps", "rowOptions"];
var F2 = function(o8) {
  var n6 = o8.tableList, i6 = o8.columns, l2 = o8.rowProps, s4 = void 0 === l2 ? {} : l2, c3 = o8.rowOptions, a7 = e(o8, A4);
  return jsx(t5.Fragment, null, jsx(P2, n({ columns: i6 }, a7)), jsx(o7, null, n6.map(function(e7, t6) {
    return jsx(z2, n({ key: e7.id, index: t6, item: e7, columns: i6, rowProps: s4, rowOptions: c3 }, a7));
  })));
};
var B3 = function(e7) {
  var r6 = e7.columns;
  return jsx(P, null, jsx(T, null, r6.map(function(e8, r7) {
    return jsx(K, { key: r7 }, e8.footer);
  })));
};
var E = ["columns", "rowProps", "tableOptions", "rowOptions", "virtualizedOptions"];
var K2 = t5.forwardRef(function(o8, n6) {
  var i6 = o8.columns, l2 = o8.rowProps, s4 = void 0 === l2 ? {} : l2, a7 = o8.tableOptions, p4 = o8.rowOptions, f2 = o8.virtualizedOptions, m2 = e(o8, E), d5 = m2.data, O2 = m2.theme, b3 = m2.layout, w2 = m2.sort, v3 = m2.pagination, y4 = m2.select, j3 = m2.tree, P3 = m2.onInit;
  return jsx(h2, { ref: n6, data: d5, theme: O2, layout: b3, sort: w2, pagination: v3, select: y4, tree: j3, onInit: void 0 === P3 ? function() {
  } : P3 }, function(e7) {
    return jsx(t5.Fragment, null, (null == a7 ? void 0 : a7.renderBeforeTable) && a7.renderBeforeTable(), f2 ? jsx(I, n({ tableList: e7, columns: i6, rowProps: s4, rowOptions: p4, virtualizedOptions: f2 }, m2)) : jsx(F2, n({ tableList: e7, columns: i6, rowProps: s4, rowOptions: p4 }, m2)), i6.some(function(e8) {
      return !!e8.footer;
    }) && jsx(B3, { columns: i6 }), (null == a7 ? void 0 : a7.renderAfterTable) && a7.renderAfterTable());
  });
});
export {
  K2 as CompactTable
