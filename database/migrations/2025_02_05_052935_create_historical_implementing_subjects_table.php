...
return new class extends Migration
{
    ...
    {
        Schema::create('historical_implementing_subjects', function (Blueprint $table) {
            $table->id('historical_implementing_subject_id');
    ...
    {
        Schema::dropIfExists('historical_implementing_subjects');
    }
};
